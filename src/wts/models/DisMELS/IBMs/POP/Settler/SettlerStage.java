...
//            wts.models.DisMELS.IBMs.Arrowtooth.EggStage.EggStagePointFT.class.getName();
    ...
    /**
     * Creates a new instance of SettlerStage.  
    ...
    /**
     * Creates a new instance of SettlerStage LHS with the given typeName.
    ...
    /**
     * Creates a new instance of SettlerStage LHS with type name and
    ...
    private void setIBMFunctions(){
        fcnLatW  = params.getSelectedIBMFunctionForCategory(SettlerStageParameters.FCAT_LengthAtWeight);
