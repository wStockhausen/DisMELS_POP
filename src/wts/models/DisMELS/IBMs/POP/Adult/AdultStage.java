...
//            "wts.models.DisMELS.LHS.BenthicAdult.AdultStagePointFT";
    ...
    public static final String[] spawnedLHSClasses = new String[]{LarvaStage.class.getName()};
    ...
    private void doSpawning() {
        try {
            ...
            for (int i=0;i<fecundity;i++) {
                ...
                if (newAttsI instanceof LarvaStageAttributes) {
                    LarvaStageAttributes newAtts = (LarvaStageAttributes) newAttsI;
